      ...
      const resolveTimer = setTimeout(() => {
        ...
        if (matrixStep === 3) {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => setArrowsVisible(true), 1600);
          }, 450);
        }
      }, 900);
        ...
        <div className="flex flex-col items-start gap-4 mt-6">
          ...
          <div className="matrix-lab" aria-live="polite">
            ...
            <svg className="vector-plot" viewBox="0 0 100 100" role="img" aria-label={`Two vectors with an angle of ${vectorAngle} degrees`}>
              ...
              <line markerEnd={arrowsVisible ? "url(#vector-arrow-a)" : undefined} className={`vector-line vector-line-a${vectorsVisible ? " is-visible" : ""}`} pathLength="100" x1="50" y1="50" x2={pointA.x} y2={pointA.y} />
              <line markerEnd={arrowsVisible ? "url(#vector-arrow-b)" : undefined} className={`vector-line vector-line-b${vectorsVisible ? " is-visible" : ""}`} pathLength="100" x1="50" y1="50" x2={pointB.x} y2={pointB.y} />
